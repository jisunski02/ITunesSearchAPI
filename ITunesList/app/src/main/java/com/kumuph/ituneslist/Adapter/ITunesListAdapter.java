...
public class ITunesListAdapter extends RecyclerView.Adapter<ITunesListAdapter.ViewHolder> {
    ...
    private List<ITunesListDataModel> iTunesListDataModels = new ArrayList<>(); //instantiating ITunesListDataModel to List
    private Context context; //use to identify what context it will use, wether it will be fragment, activity, etc.
    ...
    public void onBindViewHolder(@NonNull ITunesListAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        try {
            //setting image Array on placeholder randomly, every placeholder image changes on each row everytime the user scrolls
            ...
            //Setting value on every item on the recyclerview
    ...
    public int getItemCount() {
        //Returns the size of iTunes search API
